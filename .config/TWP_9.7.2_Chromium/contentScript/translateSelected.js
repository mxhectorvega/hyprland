...
Promise.all([twpConfig.onReady(), getTabHostName()]).then(function (_) {
  ...
  async function onUp(e) {
    ...
    if ((dontShowIfSelectedTextIsTargetLang == "yes" && detectedLanguage !== currentTargetLanguage || dontShowIfSelectedTextIsTargetLang != "yes") && (dontShowIfSelectedTextIsUnknown == "yes" && detectedLanguage !== "und" || dontShowIfSelectedTextIsUnknown != "yes")) {
      init();
      if (platformInfo.isMobile.any) {
  ...
  chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    if (request.action === "TranslateSelectedText") {
      ...
      var _prevSelInfo$element, _prevSelInfo$element2, _prevSelInfo$element3;
      readSelection();
      const prevSelInfo = gSelectionInfo;
      if (!(prevSelInfo !== null && prevSelInfo !== void 0 && (_prevSelInfo$element = prevSelInfo.element) !== null && _prevSelInfo$element !== void 0 && _prevSelInfo$element.focus) && !(prevSelInfo !== null && prevSelInfo !== void 0 && (_prevSelInfo$element2 = prevSelInfo.element) !== null && _prevSelInfo$element2 !== void 0 && (_prevSelInfo$element3 = _prevSelInfo$element2.parentNode) !== null && _prevSelInfo$element3 !== void 0 && _prevSelInfo$element3.focus)) return;
      if (prevSelInfo.isInputElement && prevSelInfo.readOnly) return;
      if (prevSelInfo.text) {
        backgroundTranslateSingleText(currentTextTranslatorService, currentTargetLanguage, prevSelInfo.text).then(result => {
          if (!result) return;
          destroy();
          if (prevSelInfo.element.nodeType === 3) {
            prevSelInfo.element.parentNode.focus();
...
//# sourceMappingURL=https://raw.githubusercontent.com/FilipePS/TWP---Source-Maps/main/maps/9.7.2/translateSelected.js.map
