...
Promise.all([twpConfig.onReady(), getTabHostName()]).then(function (_) {
  ...
  function translateThisNode(node, usePrevNode = false) {
    ...
    backgroundTranslateSingleText(currentTextTranslatorService, currentTargetLanguage, text).then(result => {
      if (!result) return;
...
//# sourceMappingURL=https://raw.githubusercontent.com/FilipePS/TWP---Source-Maps/main/maps/9.7.2/showTranslated.js.map
