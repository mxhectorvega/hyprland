    ...
    });
    {
      ...
      if (typeof browser != "undefined" && browser.theme) {
        ...
        chrome.theme.onUpdated.addListener(updateInfo => {
          themeColorFieldText = null;
          themeColorAttention = null;
          if (updateInfo.theme.colors && updateInfo.theme.colors.toolbar_field_text) {
            themeColorFieldText = updateInfo.theme.colors.toolbar_field_text;
          }
          if (updateInfo.theme.colors && updateInfo.theme.colors.icons_attention) {
...
//# sourceMappingURL=https://raw.githubusercontent.com/FilipePS/TWP---Source-Maps/main/maps/9.7.2/background.js.map
